...
class InputMoinderCoutPage(tk.Frame):
    ...
    def create_widgets(self):
        ...
        info_text = (
            ...
            "L'algorithme du Moindre Coût sélectionne à chaque étape\n"
            "la cellule avec le coût le plus faible."
        )
    ...
    def show_manual_input(self):
        ...
        dialog.title("Saisie manuelle - Moindre Coût")
    ...
    def calculate_initial_cost(self):
        """Calculate a dummy initial cost (replace with actual Least Cost implementation)"""
